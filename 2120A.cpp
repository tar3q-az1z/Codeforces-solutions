...
int main(void){
    ...
    while(++tcase, t--){
        ...
        if(l1 == l2 && l2 == l3 && l1 == (b1 + b2 + b3)) cout << "YES" << ln;
        else if(b1 == b2 && b2 == b3 && b1 == l1 + l2 + l3) cout << "YES" << ln;
        else if(b2 + b3 == b1 && l2 == l3 && b1 == l1 + l2) cout << "YES" << ln;
        else if(l2 + l3 == l1 && b2 == b3 && l1 == b1 + b2) cout << "YES" << ln;
        else cout << "NO" << ln;
