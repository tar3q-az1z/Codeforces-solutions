...
int main(void){
    ...
    while(++tcase, t--){
        i64 a, b, c, m;
        cin >> a >> b >> c >> m;
        i64 aIbIc = m / lcm(a, lcm(b, c));
        i64 aIb = m / lcm(a, b) - aIbIc;
        i64 aIc = m / lcm(a, c) - aIbIc;
        i64 bIc = m / lcm(b, c) - aIbIc;
        i64 na = m / a - aIbIc - aIb - aIc;
        i64 nb = m / b - aIbIc - aIb - bIc;
        i64 nc = m / c - aIbIc - aIc - bIc;

        i64 res1 = na * 6 + aIb * 3 + aIc * 3 + aIbIc * 2;
        i64 res2 = nb * 6 + aIb * 3 + bIc * 3 + aIbIc * 2;
        i64 res3 = nc* 6 + aIc * 3 + bIc * 3 + aIbIc * 2;
        cout << res1 << ' ' << res2 << ' ' << res3 << ln;
