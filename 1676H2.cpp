...
int main(void){
	...
	while(++tcase, t--){
		//cout << "--------Case #" << tcase << ": --------\n";
		/*
			* this problem is basically counting the no. of inversion
			* can be solved with policy based data structure in O(nlog(n))
		*/
		...
		vector<int> a(n);
		for(auto &i: a) cin >> i; 
		pbds<int, null_type, less_equal<int>> oset;
